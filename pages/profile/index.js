          ...
          <div className="flex flex-col items-center justify-center gap-5 w-[25%] px-4">
            <div className="w-full h-[200px] rounded-md bg-[#fdf2ec] flex flex-col items-center justify-start">
              <div className="relative w-[120px] h-[120px] mt-4">
                <Image
                  src="https://images.unsplash.com/photo-1654157925394-4b7809721149?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHw2fHx8ZW58MHx8fHx8&auto=format&fit=crop&w=500&q=60"
                  alt=""
                  width={10}
                  height={10}
              ...
              <span className="text-lg font-extrabold">Vung</span>
              <span className="text-base font-bold text-red-700">User</span>
            </div>
            <ul className="flex flex-col items-center justify-center w-full gap-4">
              <li className="w-full p-3 rounded-md bg-regal-red">
                <Link
                  className="inline-block w-full text-base font-bold text-center text-white"
                  href="/"
                >
                  Trang cá nhân
                </Link>
              </li>
              <li className="w-full p-3 bg-white border-4 rounded-md border-regal-red">
                <Link
                  className="inline-block w-full text-base font-bold text-center text-regal-red"
                  href="/"
                >
                  Đơn hàng của tôi
                </Link>
              ...
              <div className="flex items-start justify-between gap-8">
                ...
                <div className="flex-col items-center justify-between gap-8 w-[50%]">
                  ...
                  <div className="flex-col w-full mt-4 ">
                    ...
                    <div className="">
                      <div
                        className={`relative px-4 py-2 rounded-md w-full outline-none border border-slate-400 focus:border-slate-600 ${
