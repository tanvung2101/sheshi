    ...
    <div className={`${className} py-20`}>
      <div className="mx-auto max-w-[700px] relative flex ">
        ...
        <div className="mr-auto flex flex-col items-center justify-center gap-8 z-30">
          <div
            className={`w-24 h-24 rounded-full flex items-center justify-center z-10 border ${
              tabs === 1 ? " border-red-500 text-white" : "border-slate-600"
            }`}
          >
            <span
        ...
        <div className="mx-auto flex flex-col items-center justify-center gap-8 z-30">
          <div
            className={`w-24 h-24 rounded-full flex items-center justify-center z-10 border ${
              tabs === 2 ? " border-red-500 text-white" : "border-slate-600"
            }`}
          >
            <span
              className={`p-5 rounded-full ${
        ...
        <div className="ml-auto flex flex-col items-center justify-center gap-8 z-30">
          <div
            className={`w-24 h-24 rounded-full flex items-center justify-center z-10 border ${
              tabs === 3 ? " border-red-500 text-white" : "border-slate-600"
            }`}
          >
            <span
              className={`p-5 rounded-full ${
